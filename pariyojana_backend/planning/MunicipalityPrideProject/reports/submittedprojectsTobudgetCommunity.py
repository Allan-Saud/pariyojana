...
class SubmittedToBudgetMunicipalityPrideProjectDownloadReport(APIView):
    def get_queryset(self, request):
        queryset = SubmittedToBudgetMunicipalityPrideProject.objects.filter(is_deleted=False)
    ...
    def generate_excel(self, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename=submitted_municipality_pride_project.xlsx'
        return response
    ...
    def generate_pdf(self, request, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename="submitted_municipality_pride_project.pdf"'
        return response