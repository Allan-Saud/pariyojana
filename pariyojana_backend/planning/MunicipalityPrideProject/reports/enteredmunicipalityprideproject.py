...
class EnteredMunicipalityprideProjectChart(APIView):
    def get(self, request):
        # Query all active projects
        projects = MunicipalityPrideProject.objects.filter(is_deleted=False)
...
class MunicipalityPrideProjectDownloadReport(APIView):
    def get_queryset(self, request):
        queryset = MunicipalityPrideProject.objects.filter(is_deleted=False)
    ...
    def generate_excel(self, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename=municipality_pride_project.xlsx'
        return response
    ...
    def generate_pdf(self, request, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename="municipality_pride_project.pdf"'
        return response