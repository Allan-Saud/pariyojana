...
class PrioritizedWardLevelThematicProjectSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {
            ...
            'expenditure_title_id': {'required': False, 'allow_null': True},
            'fiscal_year_id': {'required': False, 'allow_null': True},
            'unit_id': {'required': False, 'allow_null': True},
            'project_level_id': {'required': False, 'allow_null': True},
