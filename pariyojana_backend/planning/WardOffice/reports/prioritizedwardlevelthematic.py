...
class PrioritizedWardThematicChartData(APIView):
    def get(self, request):
        ...
        projects = PrioritizedWardLevelThematicProject.objects.filter(is_deleted=False)
...
class PrioritizedWardLevelThematicProjectDownloadReport(APIView):
    ...
    def generate_excel(self, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename=prioritized_ward_level_thematic_report.xlsx'
        return response
    ...
    def generate_pdf(self, request, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename="prioritized_ward_level_thematic_report.pdf"'
        return response
