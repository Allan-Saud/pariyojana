...
class MunicipalityLevelDownloadReport(APIView):
    ...
    def generate_excel(self, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename=prioritized_ward_thematic.xlsx'
        return response
    ...
    def generate_pdf(self, queryset):
        ...
        if not pdf.err:
            return FileResponse(result, content_type='application/pdf', filename='prioritized_ward_thematic.pdf')
        else:
