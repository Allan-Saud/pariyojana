...
class SubmittedProjectsChart(APIView):
    def get(self, request):
        # Query all active projects
        projects = SubmittedProjects.objects.filter(is_deleted=False)
...
class SubmittedProjectsDownloadReport(APIView):
    def get_queryset(self, request):
        queryset = SubmittedProjects.objects.filter(is_deleted=False)
    ...
    def generate_excel(self, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename=project_submitted.xlsx'
        return response
    ...
    def generate_pdf(self, request, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename="project_submitted.pdf"'
        return response