...
class ProjectsApprovedByMunicipalChart(APIView):
    def get(self, request):
        # Query all active projects
        # projects = ProjectsApprovedByMunicipal.objects.filter(is_deleted=False)
        projects = ProjectsApprovedByMunicipal.objects.all()
...
class ProjectsApprovedByMunicipalDownloadReport(APIView):
    def get_queryset(self, request):
        # queryset = ProjectsApprovedByMunicipal.objects.filter(is_deleted=False)
    ...
    def generate_excel(self, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename=project_approved_municipality.xlsx'
        return response
    ...
    def generate_pdf(self, request, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename="project_approved_municipality.pdf"'
        return response