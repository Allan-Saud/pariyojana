...
class MunicipalityLevelProgramViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return MunicipalityLevelProgram.objects.filter(is_deleted=False)
    ...
    def submit_to_executive(self, request, pk=None):
        try:
            ...
            return Response({"message": "Submitted to Municipality Executive Office and soft-deleted."}, status=200)
