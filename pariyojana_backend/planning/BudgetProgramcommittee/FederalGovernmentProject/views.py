...
from planning.BudgetProgramcommittee.FederalGovernmentProject.serializers import BudgetProgramFederalGovernmentProgramSerializer


class BudgetProgramFederalGovernmentProgramViewSet(viewsets.ModelViewSet):
    serializer_class = BudgetProgramFederalGovernmentProgramSerializer

    def get_queryset(self):
        return BudgetProgramFederalGovernmentProgram.objects.filter(is_deleted=False)
    ...
    def submit_to_executive(self, request, pk=None):
        try:
            ...
            PreAssemblyProject.objects.create(
                ...
                status="बजेट तथा कार्यक्रम तर्जुमा समितिले सिफारिस गरेका संघीय सरकारका कार्यक्रम",
                priority_no=project.priority_no,
                remarks=project.remarks,
            )

            # ✅ Soft delete original project
            project.status = "बजेट तथा कार्यक्रम तर्जुमा समितिले सिफारिस गरेका संघीय सरकारका कार्यक्रम"
        ...
        except BudgetProgramFederalGovernmentProgram.DoesNotExist:
