...
class BudgetProgramCommitteeWardLevelProgramDownloadReport(APIView):
    def get_queryset(self, request):
        queryset = BudgetProgramCommitteeWardLevelProgram.objects.filter(is_deleted=False)
    ...
    def generate_excel(self, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename=ward_level_budgetcommittee.xlsx'
        return response
    ...
    def generate_pdf(self, request, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename="ward_level_budgetcommittee.pdf"'
        return response