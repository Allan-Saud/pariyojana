...
class BudgetProgramMunicipalityPrideProgramChart(APIView):
    def get(self, request):
        # Query all active projects
        projects = BudgetProgramMunicipalityPrideProgram.objects.filter(is_deleted=False)
...
class BudgetProgramMunicipalityPrideProgramDownloadReport(APIView):
    def get_queryset(self, request):
        queryset = BudgetProgramMunicipalityPrideProgram.objects.filter(is_deleted=False)
    ...
    def generate_excel(self, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename=municipality_pride_report.xlsx'
        return response
    ...
    def generate_pdf(self, request, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename="municipality_pride_report.pdf"'
        return response