...
class ThematicCommitteeProgramDownloadReport(APIView):
    def get_queryset(self, request):
        queryset = ThematicCommitteeProgram.objects.filter(is_deleted=False)
    ...
    def generate_excel(self, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename=thematic_committee.xlsx'
        return response
    ...
    def generate_pdf(self, request, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename="thematic_committee.pdf"'
        return response