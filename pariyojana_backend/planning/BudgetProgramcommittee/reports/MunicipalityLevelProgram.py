...
class MunicipalityLevelProgramChart(APIView):
    def get(self, request):
        # Query all active projects
        projects = MunicipalityLevelProgram.objects.filter(is_deleted=False)
...
class MunicipalityLevelProgramDownloadReport(APIView):
    def get_queryset(self, request):
        queryset = MunicipalityLevelProgram.objects.filter(is_deleted=False)
