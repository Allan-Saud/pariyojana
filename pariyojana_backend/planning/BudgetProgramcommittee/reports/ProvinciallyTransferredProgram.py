...
class ProvinciallyTransferredProgramChart(APIView):
    def get(self, request):
        # Query all active projects
        projects = ProvinciallytransferredProgram.objects.filter(is_deleted=False)
...
class ProvinciallytransferredProgramDownloadReport(APIView):
    def get_queryset(self, request):
        queryset = ProvinciallytransferredProgram.objects.filter(is_deleted=False)
    ...
    def generate_excel(self, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename=provincially_transferred.xlsx'
        return response
    ...
    def generate_pdf(self, request, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename="provincially_transferred.pdf"'
        return response