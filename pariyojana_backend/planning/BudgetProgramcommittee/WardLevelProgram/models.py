...
class BudgetProgramCommitteeWardLevelProgram(models.Model):
    plan_entry = models.ForeignKey(
        PlanEntry, on_delete=models.CASCADE,
    ...
    gps_coordinate = models.CharField(max_length=255, blank=True, null=True, verbose_name="GPS समन्वय")
    expected_result = models.TextField(blank=True, null=True, verbose_name="अपेक्षित परिणाम")
    location = models.CharField(max_length=255, blank=True, null=True, verbose_name="स्थान")

    feasibility_study = models.CharField(max_length=10, choices=YES_NO_CHOICES, blank=True, null=True, verbose_name="सम्भाव्यता अध्ययन")
    feasibility_file = models.FileField(upload_to="plan/feasibility/", null=True, blank=True)
    detailed_study = models.CharField(max_length=10, choices=YES_NO_CHOICES, blank=True, null=True, verbose_name="विस्तृत अध्ययन")
    detailed_file = models.FileField(upload_to="plan/detailed/", null=True, blank=True)
    environmental_study = models.CharField(max_length=10, choices=YES_NO_CHOICES, blank=True, null=True, verbose_name="पर्यावरणीय अध्ययन")
    environmental_file = models.FileField(upload_to="plan/environmental/", null=True, blank=True)

    status = models.CharField(max_length=255, default="बजेट तथा कार्यक्रम तर्जुमा समितिमा सिफारिस भएको वडा स्तरीय परियोजना", verbose_name="स्थिती")
