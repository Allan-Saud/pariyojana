...
class PreAssemblyProjectDownloadReport(APIView):
    def get_queryset(self, request):
        queryset = PreAssemblyProject.objects.filter(is_deleted=False)
    ...
    def generate_excel(self, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename=pre_assembly.xlsx'
        return response
    ...
    def generate_pdf(self, request, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename="pre_assembly.pdf"'
        return response