...
class CouncilSubmittedProjectDownloadReport(APIView):
    ...
    def generate_excel(self, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename=council_submitted_project.xlsx'
        return response
    ...
    def generate_pdf(self, request, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename="council_submitted_project.pdf"'
        return response