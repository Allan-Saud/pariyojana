...
class WardRecommendedProjectsDownloadReport(APIView):
    ...
    def generate_excel(self, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename=ward_recommended_report.xlsx'
        return response
    ...
    def generate_pdf(self, request, queryset):
        ...
        response['Content-Disposition'] = 'attachment; filename="ward_recommended_report.pdf"'
        return response