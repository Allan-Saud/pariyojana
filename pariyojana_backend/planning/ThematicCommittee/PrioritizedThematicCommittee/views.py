...
class PrioritizedThematicCommitteeViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return PrioritizedThematicCommittee.objects.filter(is_deleted=False)
    ...
    def submit_to_budget_committee(self, request, pk=None):
        try:
            ...
            return Response({"message": "Successfully submitted to Budget Committee and soft-deleted."}, status=200)
