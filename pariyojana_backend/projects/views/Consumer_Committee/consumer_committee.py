...
#     if serial_no == 4:
#         try:
#             committee_detail = ConsumerCommitteeDetail.objects.get(
#                 project__serial_number=project_serial_number, is_active=True
#             )
#             context["consumer_committee_details"] = committee_detail
#         except ConsumerCommitteeDetail.DoesNotExist:
#             context["consumer_committee_details"] = None
