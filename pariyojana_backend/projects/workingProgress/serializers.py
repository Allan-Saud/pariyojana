...
class WorkProgressSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = WorkProgress
        fields = ['id', 'project_name', 'fiscal_year', 'fiscal_year_display', 'work_type', 'work_type_id', 'quantity', 'remarks', 'created_at']
        read_only_fields = ['created_at', 'project_name', 'fiscal_year_display', 'project']
