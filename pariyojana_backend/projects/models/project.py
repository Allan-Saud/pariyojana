...
class Project(models.Model):
    serial_number = models.AutoField(primary_key=True)  # क्र.स (Auto increment)
    ...
    budget = models.DecimalField("बजेट", max_digits=15, decimal_places=2)  # currency amount
    WARD_CHOICES = [(i, f"वडा नंं. {i}") for i in range(1, 9)]  # 1 to 8
